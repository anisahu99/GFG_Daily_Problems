<h2><a href="https://practice.geeksforgeeks.org/problems/longest-distinct-characters-in-string5848/1?utm_source=geeksforgeeks&utm_medium=ml_article_practice_tab&utm_campaign=article_practice_tab">Longest Distinct characters in string</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>S</strong>, find the length of the longest substring with all distinct characters.&nbsp;</span></p>
