<h2><a href="https://practice.geeksforgeeks.org/problems/egg-dropping-puzzle-1587115620/1?page=2&category[]=Dynamic%20Programming&sortBy=submissions">Egg Dropping Puzzle</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given <strong>N</strong> identical eggs and you have access to a <strong>K</strong>-floored building from&nbsp;<strong>1</strong>&nbsp;to&nbsp;<strong>K</strong>.</span></p>
